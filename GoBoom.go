...
func getProxyList_genode() []string {
    // get the list of proxy at https://raw.githubusercontent.com/dpangestuw/Free-Proxy/refs/heads/main/http_proxies.txt
    // return a list of proxy
    var proxy_list []string
    resp, err := http.Get("https://raw.githubusercontent.com/dpangestuw/Free-Proxy/refs/heads/main/http_proxies.txt")
    if err != nil {
        log.Fatal(err)
    }
    defer resp.Body.Close()
